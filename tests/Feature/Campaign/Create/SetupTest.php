...
test('it should have on the view the form variable set to config', function() {
    get($this->route)
        ->assertViewHas('view', 'config');
});
...
describe('validations', function () {
    ...
    test('name should have a max of 255 characteres', function() {})->todo();
    test('subject should have a max of 40 characteres', function() {})->todo();
