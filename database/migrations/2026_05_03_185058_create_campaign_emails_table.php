...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('campaign_emails', function (Blueprint $table) {
            $table->id();
            $table->foreignId('campaign_id')->constrained()->references('id')->on('campaigns')->onDelete('cascade');
            $table->foreignId('subscriber_id')->constrained()->references('id')->on('subscribers')->onDelete('cascade');
